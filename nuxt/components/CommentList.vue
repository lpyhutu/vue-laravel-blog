    ...
    methods: {
        ...
        handleCommentShow(key, keyTwo) {
            ...
            const { display } = this.$refs[
                keyVal
            ][0].parentElement.parentElement.parentElement.parentElement.parentElement.nextElementSibling.firstElementChild.style;
            if (display === "" || display === "none") {
                this.$refs[
                    keyVal
                ][0].parentElement.parentElement.parentElement.parentElement.parentElement.nextElementSibling.firstElementChild.style.display =
                    "block";
            } else {
                this.$refs[
                    keyVal
